            ...
            {edit ? <>
                ...
                >
                    <form aria-label='edit title form' onSubmit={(e) => handleSaveEdit(e)} style={{padding: '5px 0px'}}>
                        <Stack horizontal verticalAlign={'start'} className={styles.containerEditTitleForm}>
                            <Stack.Item>
                                <TextField
                ...
                <Stack horizontal verticalAlign={'center'} style={{ width: '100%' }}>
                    ...
                    {(isSelected || isHovered) && <Stack horizontal className={styles.buttonContainer} horizontalAlign='end'>
